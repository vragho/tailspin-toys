...
The home page includes category checkboxes and a publisher selector for narrowing the game list. Multiple categories can be selected together, and the filters can be combined without leaving the page.
